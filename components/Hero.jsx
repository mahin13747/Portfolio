      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
            <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
               <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>Hi There, <br />I'm Mahendra <span className='text-red-500'>Naidu</span></h1>
               ...
               <button className='bg-black text-white px-3 py-2 w-max rounded-md'><a href="https://docs.google.com/document/d/1qqpBLkC4vnOlPZwkfT2JG5wWICEodNRs-VAZPSI-BPA/edit?tab=t.0" download target='_blank'>Download CV</a></button>
            </div>
